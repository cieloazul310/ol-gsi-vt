...
- *sourceOptions?*: `<Object>` `Omit<VectorTileSourceOptions, "url" | "format" | "attributions">`  
  参照 [ol/source/VectorTile]
...
- ...and [ol/layer/VectorTile] options

#### returns

`<class>` [ol/layer/VectorTile]
...
[ol/layer/VectorTile]: https://openlayers.org/en/latest/apidoc/module-ol_layer_VectorTile-VectorTileLayer.html "ol/layer/VectorTile"
...
[ol/source/VectorTile]: https://openlayers.org/en/latest/apidoc/module-ol_source_VectorTile-VectorTile.html "ol/source/VectorTile"
